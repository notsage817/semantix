...
class JobPosting:
    ...
    def load_multiple_from_file(cls, file_path: str) -> List["JobPosting"]:
        ...
        if isinstance(data, list):
            ...
            raise ValueError(
                "JSON file must contain either a list of jobs or an object with a 'jobs' key"
            )
    ...
    def has_salary_info(self) -> bool:
        ...
        return (
            ...
            or self.hourly_rate_min is not None
            or self.hourly_rate_max is not None
            or bool(self.pay_benefit.strip())
        )
